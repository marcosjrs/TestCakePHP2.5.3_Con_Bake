<div class="cocineros index">
	<div class="page-header"><h2><?php echo __('Cocineros'); ?></h2></div>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $cocinero['Cocinero']['id']), array( "class"=>"btn btn-xs btn-primary")); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $cocinero['Cocinero']['id']), array( "class"=>"btn btn-xs btn-primary")); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cocinero['Cocinero']['id']), array("class"=>"btn btn-xs btn-danger"), __('Are you sure you want to delete # %s?', $cocinero['Cocinero']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
